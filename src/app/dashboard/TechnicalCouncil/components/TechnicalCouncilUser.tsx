...
export const TechnicalCouncilUser = ({
	name,
	pfp,
	isMicrophoneOn,
	...
	return (
		<div className={`flex justify-between relative`}>
			...
			<div className='flex gap-2 items-center'>
				<div className='flex'>
					{
						pfp ? <Image className='rounded-full' src={pfp} alt={name} width={40} height={40} /> : <div className='w-10 h-10 bg-neutrals-secondary rounded-full flex items-center justify-center text-brand-gray font-semibold text-base'>{name.slice(0,2)}</div>
					}
				</div>
