...
const ChatListItem = ({data}: ChatListItemProps) => {
	return (
		<div className={`relative flex items-center flex-col p-4 rounded-lg hover:cursor-pointer ${data.active ? 'bg-secondary' : ''}`}>
			{data.active && (
