      ...
      openSideMenu ? (
        ...
        techCouncilMenuValue === "chat" ? (
          <div className={`flex-grow bg-neutrals-secondary ${isTechnicalCouncil ? "rounded-lg" : ""}`}>
            <div className={`${isTechnicalCouncil ? "h-[calc(90vh-270px)]" : "h-[calc(100vh-130px)] md:h-[calc(100vh-180px)] lg:h-[calc(100vh-240px)]"} overflow-y-auto flex flex-col`} ref={messagesRef}>
