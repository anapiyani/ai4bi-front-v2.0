...
const Icons = {
	...
	Choose_files: () => {
		return (
			<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M2.88281 7.66773L7.18674 3.52094C11.2583 -0.407306 17.8709 5.65307 13.6338 9.74112L8.29962 14.8876C5.5368 17.5532 1.04964 13.4408 3.92485 10.6667L9.18225 5.59434C10.6364 4.19139 12.998 6.35581 11.4848 7.81583L7.11767 12" stroke="#64748B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
			</svg>
		)
	},
	Select_chat: () => {
