...
const AuctionLeaveButton = ({handlers, techCouncilUser}: TechnicalCouncilLeaveButtonProps) => {
  ...
  const handleToggleDialog = () => {
	...
	return (
      ...
      <Button 
		...
		>
			<p className='hidden lg:block md:block'>{t("leave-auction")}</p>
			<Icons.HeaderClose />
		</Button>	
...
export default AuctionLeaveButton;